                                        ...
                                        <div class="card-description black">
                                            <div class="text-center my-3">
                                                ...
                                                <svg version="1.1" xmlns="http://www.w3.org/2000/svg"
                                                    xmlns:xlink="http://www.w3.org/1999/xlink" width="180px"
                                                    height="80px" viewBox="0 0 380 134">
                                            ...
                                            <div class="card-footer">
                                                <a href="#footer">
                                                    <button
                                                        class="btn btn-block btn-round btn-primary"><?= $form_btn ?></button>
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <td class="td-actions text-right">
                                        <a href="#footer">
                                            <button type="button" class="btn btn-primary btn-sm my-auto"
                                                data-date="<?= $dates ?>" onclick="setDate(this)">
                                                Забронировать
                                            </button>
                                        </a>
                                    </td>
        ...
        <div class="col-md-6 mx-auto">
            <div class="card card-profile card-plain">
                <div class="card-img-top">
                    <iframe width="100%" height="305px" src="https://www.youtube.com/embed/<?= $video_code ?>/"
    ...
    <div class="row">
        <div class="mx-auto col-md-8 mt-3">
            ...
            <div class="col-md-6 mx-auto my-3">
                <a href="#footer">
                    <button type="button" class="btn btn-danger btn-block btn-round mb-5"
                        style="max-width: 100%;margin: auto;">Свяжитесь с нами</button>
                </a>
            </div>
        </div>
    </div>
...
<div class="col-md-12 mt-3" id="dropDownFromHere">
    <div class="dropdown">
        <div class="form-control dropdown-toggle" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true"
            aria-expanded="false">
            Даты путешествия?
        </div>
