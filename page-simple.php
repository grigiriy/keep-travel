    ...
    <div id="carouselExampleIndicators" class="page-header carousel slide" data-ride="carousel">
        <div class="carousel-inner">
            ...
            <div class="carousel-item <?php if($i == 0){ echo 'active'; }; ?>"
                style="background-image:url(<?= wp_get_attachment_image_url( $back_img[$i]['back_image'], 'full' ) ?>);height:100vh;background-size:cover">
            </div>
            <?php } ?>
        </div>
        <style type="text/css">
                ...
                <div class="container">
                    <div class="row my-5">
                        <div class="col-md-9 mx-auto text-center mb-5">
                            ...
                            <h5>Познай себя и мир активно путешествуя и заряжаясь<br>новыми эмоциями в группе
                                единомышленников!<br>Всю организацию мы берем на себя.</h5>
    ...
    <div class="minh-100vh px-3 pb-5">
        <div class="container-fluid px-0">
          ...
          for ($i = 0; $i < 12; $i++) {
            ...
            ?>
                        <div class="card mt-3 _dark <?= $is_offset ?>" data-background="image"
                            style="background-image: url(<?= $image; ?>)">
                            <a href="<?= the_permalink($post->ID); ?>"
                                class="btn btn-link btn-neutral px-0 card-link-wrap">
        ...
        <div class="row">
            <div class="col-md-4 info">
                <div class="description">
                    ...
                    <p class="white">Из них с нами было <?= $counters[0]['male'] ?> мужчин и
...
<!-- whatsapp form -->
<div id="wa_form" class="" onclick="window.location.href = 'https://api.whatsapp.com/send?phone=79854287400';">
    <div class="_header">
...
<div id="phone_btn_wrap">
    <a href="https://api.whatsapp.com/send?phone=79854287400">
