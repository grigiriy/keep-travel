...
<head>
    ...
    })(window, document, 'script', 'dataLayer', 'GTM-5T6XRK7');
    </script>
...
<body>
    ...
    <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-5T6XRK7" height="0" width="0"
    ...
    <nav class="navbar navbar-expand-lg fixed-top nav-down navbar-transparent" color-on-scroll="600">
        <div class="container-fluid header-container">
            ...
            $ancor = '#footer'; ?>
                    ...
                    <li class="nav-item">
                        <p class="nav-link"><a style="font-size: 1.5em;line-height: 1em;" href="tel:84993808699">+7(499)
                                380-86-99</a></p>
                    </li>
                    <li class="nav-item">
